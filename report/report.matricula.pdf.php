...
if (isset($_GET['matricula'])) {
    try {
        ...
        {        
            ...
            $this->Cell(47, 10, utf8_decode('CODIGO DE MATRÍCULA:'), 0, 0, 'L', 0);
            $this->Cell(47, 10, $this->codigoMatricula, 0, 0, 'C', 0);
            $this->Cell(47, 10, utf8_decode('FECHA DE LA MATRÍCULA:'), 0, 0, 'L', 0);
            ...
            $this->Cell(23, 10, utf8_decode('GRUPO:'), 0, 0, 'L', 0);
            $this->Cell(23, 10, $this->grado. ' '. $this->seccion, 0, 0, 'C', 0);
            $this->Cell(23, 10, utf8_decode('TURNO:'), 0, 0, 'C', 0);
            $this->Cell(23, 10, $this->turno, 0, 0, 'C', 0);
            $this->Cell(23, 10, utf8_decode('ESTADO:'), 0, 0, 'C', 0);
            $this->Cell(23, 10, $this->estado, 0, 0, 'C', 0);
            $this->Cell(23, 10, utf8_decode('AÑIO:'), 0, 0, 'C', 0);
            ...
            $this->Cell(47, 10, utf8_decode('DIRECCIÓN DOMICILIAR:'), 0, 0, 'L', 0);
            ...
            $this->Line(150, $yCurrentPosition - 3, 200, $yCurrentPosition - 3);
            $this->Cell(47, 10, 'CEDULA: ', 0, 0, 'L', 0);
            $this->Cell(47, 10, utf8_decode($this->cedulaTutor), 0, 0, 'C', 0);
            $this->Cell(47, 10, 'PARENTESCO: ', 0, 0, 'L', 0);
            $this->Cell(47, 10, utf8_decode($this->parentesco), 0, 1, 'C', 0);
            $yCurrentPosition = $this->GetY();
            $this->Line(53, $yCurrentPosition - 3, 100, $yCurrentPosition - 3);
            $this->Line(150, $yCurrentPosition - 3, 200, $yCurrentPosition - 3);
            $this->Cell(47, 10, 'TELEFONO CELULAR: ', 0, 0, 'L', 0);
            $this->Cell(47, 10, utf8_decode($this->telefonoTutor), 0, 0, 'C', 0);
            $this->Cell(47, 10, 'CORREO ELECTRONICO: ', 0, 0, 'L', 0);
            $this->Cell(47, 10, utf8_decode($this->correoTutor), 0, 1, 'C', 0);
            $yCurrentPosition = $this->GetY();
            $this->Line(53, $yCurrentPosition - 3, 100, $yCurrentPosition - 3);
            $this->Line(150, $yCurrentPosition - 3, 200, $yCurrentPosition - 3);
            $this->Cell(47, 10, 'DIRECCION DOMICILIAR: ', 0, 0, 'L', 0);
            $this->Cell(47, 10, utf8_decode($this->direccionTutor), 0, 1, 'C', 0);
            $yCurrentPosition = $this->GetY();
            $this->Line(53, $yCurrentPosition - 3, 100, $yCurrentPosition - 3);
    ...
    $pdf->Output(utf8_decode('Hoja de Matrícula de '.$primerNombreEstudiante.'.pdf'), 'I');
