<?php
require_once("/Programas2/laragon/www/fpdf186/fpdf.php");
require_once('/Programas2/laragon/www/models/conexion.model.php');
require_once('/Programas2/laragon/www/models/USERS.model.php');
