    ...
    <form action="" class="form ms-2">
        ...
        <div id="form_estudiante"class="ms-2">
            ...
            <div class="inputs-group">
                ...
                <div class="cajas-texto">
                    <input class="form-control" type="date" placeholder="Apellidos" />
                ...
                <div class="cajas-texto">
                    <input class="form-control" type="number" placeholder="Teléfono celular" />
                    <i class="bi bi-telephone-fill icon"></i>
                </div>
    
                <div class="cajas-texto cont">
                    <input class="form-control" name="" id="" cols="30" rows="1" placeholder="Direccion" />
