<div class="modal fade" id="modal_report_calificaciones" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content bg-dark text-light">
            ...
            <div class="modal-body">
                <form action="/report/reports.calificaciones.pdf.php" method="POST">
