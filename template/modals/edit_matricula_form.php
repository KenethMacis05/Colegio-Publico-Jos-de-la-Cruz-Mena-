                ...
                <form action="/controllers/matricula.controller.php" method="POST">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-select" id="FK_Estudiante" name="FK_Estudiante" required style="background-color: #E5E5E5;">
                                <option value="<?= $matricula['FK_Estudiante']; ?>"><?= $matricula["Pri_Nombre"] . ' ' . $matricula["Pri_Apellido"]; ?></option>
                                <?php
